                        ...
                        <div className="col-12">
                            <div className="topMargin">
                                ...
                                <div className="lead mt-5 mb-5">
                                    วัดโดยส่วนใหญ่นิยมแบ่งเขตภายในวัดออกเป็นสองส่วนคือ พุทธาวาส และสังฆาวาส โดยส่วนพุทธาวาสจะเป็นที่ตั้งของสถูปเจดีย์ อุโบสถ สถานที่ประกอบกิจกรรมทางพระพุทธศาสนา และส่วน
                            ...
                            <div className="container">
                                <div className="row">
                                    {Data.map((listTemple, inddex) => {
                                        return (
                                            <div className="col-md-6 col-12 mt-3" style={{
                                                borderLeft: '5px solid #fff',
                                                borderTop: '5px solid #fff', overflow: 'hidden'
                                            }}>
                                                <div style={{
                                                    backgroundImage: `url(${listTemple.img[0]})`, width: '100%',
                                                    padding: '250px auto',backgroundSize:'cover',
                                                }} key={inddex}>
                                                    <h1 className="text-warning  text-center py-5" style={{backgroundColor:'rgba(0,0,0,0.2)' }}>
                                                        {listTemple.title}
                                                    </h1>
                                                    <div className="text-white text-center pt-2 bg-dark">
                                                        {listTemple.subtitle}
                                                    </div>
